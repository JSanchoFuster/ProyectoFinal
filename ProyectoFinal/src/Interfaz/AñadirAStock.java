 ...
 * @author alumno
 */
public class AñadirAStock extends javax.swing.JFrame {
    ...
    public AñadirAStock() {
        ...
        validado=false;
        jComboBox3.setModel(cargarModeloArticulos(con.conseguirCodArticuloStock()));
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String cabecera1 = (String)jComboBox3.getSelectedItem();
        if (!(cabecera1.equalsIgnoreCase("Codigo Articulo"))){
            con.actualizarStock(Integer.valueOf(cabecera1),(int)jSpinner1.getValue());
            this.dispose();
        }        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AñadirAStock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AñadirAStock().setVisible(true);
            }
        });
    }
    Conexion con;
